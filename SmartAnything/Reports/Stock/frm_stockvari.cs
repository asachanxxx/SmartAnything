...
{
    public partial class frm_stockvari : Form
    {

        int formMode = 0;
        string formID = "R0007";
        string formHeadertext = "Stock Variance Report";
        DataTable dtx = new DataTable();

        #region Loading one instance

        private static frm_stockvari objSingleObject = null;

        /// <summary>
        /// Singleton object creation method
        /// </summary>
        /// <returns>object of a frmM_Supplier</returns>
        public static frm_stockvari getSingleton()
        {
            if (objSingleObject == null || objSingleObject.IsDisposed)
            {
                objSingleObject = new frm_stockvari();
        ...
        public frm_stockvari()
        {
            InitializeComponent();
        }

        private void frm_stockvari_Load(object sender, EventArgs e)
        {
